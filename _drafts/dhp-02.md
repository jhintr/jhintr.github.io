...
> + 此處 `pada` 意為處所或狀態，參見 __1__ 注。

##### 22. Evaṃ <small>(Etaṃ)</small> visesato ñatvā, appamādamhi paṇḍitā, appamāde pamodanti, ariyānaṃ gocare ratā.
...
> + __Dhp-a__: _dhīrā paṇḍitā_. 英譯通常按注釋將 `dhīrā` 解作堅定或智慧。
...
> + __GDhp__ 111 作 _ya jara nabhimardati_，__Udāna-v__ 作 _tam ogho nābhimardati_。
> + 因為`洪水`指的是輪迴，故此處 `dīpa` 必意為`洲`，參見 __236, 238__。至於吳譯作`冥淵`（黑暗）而不是洪水，Brough 認為可能有別本作 _taṃm ogho > taṃ mogho_，進而將 _mogho_ 解作 _moho_（愚癡），如此則 _dīpa_ 意為燈（`錠明`？）。

---

##### 26. Pamādam-anuyuñjanti, bālā dummedhino janā, appamādañca medhāvī, dhanaṃ seṭṭhaṃ va rakkhati.
...
##### 27. Mā pamādam-anuyuñjetha, mā kāmaratisanthavaṃ, appamatto hi jhāyanto, pappoti vipulaṃ sukhaṃ.
...
> + `kāmaratisanthava` 也可依相違釋（dvandva）作「欲樂、喜悅及嗜愛」。

---

##### 28. Pamādaṃ appamādena, yadā nudati paṇḍito, paññāpāsādam-āruyha, asoko sokiniṃ pajaṃ, pabbataṭṭho va bhūmaṭṭhe, dhīro bāle avekkhati.
...
> + __WD__ 依上下文將 `paññā` 及其派生詞解作知識或智慧。
...
##### 31. Appamādarato bhikkhu, pamāde bhayadassivā, saṃyojanaṃ aṇuṃthūlaṃ, ḍahaṃ aggīva gacchati.
...
> + 此處 `bhayadassivā` 意為「見到危險」，參見 _bhayadassino_ __317__。案，葉譯將此詞分讀作 _bhayadassi vā_，故有`或者`二字。
