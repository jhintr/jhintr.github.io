...
> 1. **闻**一词，带前缀与不带前缀，有服行、闻名、染污、积累、践行、耳所识者、随从耳门之所识等多种义项。如在「从事 *pasuto* 戎行」等处为服行，在<div>见所闻法者⋯⋯<q>自说第 11 经</q></div>等处义为闻名之法，在<div>心怀漏泄 *avassutā*，（受用）心怀漏泄的⋯⋯<q>波夷提第 657 段</q></div>等处义为染污、不染污，在<div>尔等产生 *pasutaṃ* 之福德匪浅。<q>小诵第 7.12 颂</q></div>等处义为积累，在<div>智者修禅定。<q>法句第 181 颂</q></div>等处义为践行禅那，在<div>所见、所闻、所觉。<q>中部第 1.241 段</q></div>等处义为耳所识者，在<div>忆持所闻、积聚所闻。<q>中部第 1.339 段</q></div>等处义为随从耳门之所识，而此处其义为因随从耳门之所理解或理解。因为当**我**字义为「由我」时，「如是由我所闻」，则因随从耳门之所理解适合，当义为「我的」时，「我的所闻如是」，则因随从耳门之理解适合。
