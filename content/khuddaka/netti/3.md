...
诸法以同一，还以差异被指出，  
它们不应被设定，这即是**基准**导引。[^18-1]

[^18-1]: 义注对此的解释是：**它们不应被设定**，在经中以「苦、集」等统一，和以「生、老、欲爱、有爱」等差别所开示的诸法，它们不应以「此中何为统一、何为差别」等设定统一与差别的方式来设定。为什么？由统一与差别之设想因俗称之相而非确定故，且如时间、方向的差别般，由相较而成立故。因为好比所说的「今天、昨天、明天」等时间的差别和「东方、西方」等方向的差别无确定的自性，统一与差别也如是。同样，尽管在说「此是苦」时，以相较于生等而为统一，同一（苦）以相较于谛则为差别。集等处亦仿此。
