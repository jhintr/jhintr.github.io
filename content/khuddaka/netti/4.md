...
[^322-1]: 此颂是世尊在遮婆罗塔 *Cāpāla cetiya* 具念正知，舍弃寿行 *āyusaṅkhāra* 后所说。这里的译文是为了匹配下文的解释。但相应部（与本论）的义注给出了两种解释，详见菩提比丘译注 255，这里略述如下。义注的解释一，「等与无等」分别指欲界和大界的业，或者，等指欲界、色界的业，无等指无色界的业。解释二，将「等 *tulam*」解释作 tuleti 的现在分词体格，将「无等」和「生成」对立，分别指涅槃和有，「有行」指业，则第一句应译作「衡量着无等和生成」。且菩提比丘进一步认为，「生成」在这里应指佛陀刚刚舍弃的从此时起一劫的寿命，「有行」则指经文中的「寿行」，如此正与经文之意相契。
